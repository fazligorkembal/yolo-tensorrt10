                    ...
                    float **decode_ptr_host, float **decode_ptr_device, std::string cuda_post_process)
{
    ...
    context.setTensorAddress(kProtoTensorName, (float *)*output_seg_buffer_device);
...
int main(int argc, char **argv)
{
    ...
    prepare_buffer(engine, *context, &device_buffers[0], &device_buffers[1], &device_buffers[2], &output_buffer_host,
